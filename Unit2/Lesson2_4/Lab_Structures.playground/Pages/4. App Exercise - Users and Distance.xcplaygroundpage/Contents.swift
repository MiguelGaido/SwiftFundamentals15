...
print("User Name: \(exampleUser.name)")
print("Age: \(exampleUser.age)")
print("Height: \(exampleUser.height) inches")
print("Weight: \(exampleUser.weight) lbs")
print("Activity Level: \(exampleUser.activityLevel)/10")
...
print("\(miguel.name) is \(miguel.age) years old, \(miguel.height) inches tall, weighs \(miguel.weight) lbs, and has an activity level of \(miguel.activityLevel)/10.")
/*:
...
var shortRun = Distance(meters: 500)

print("Distance in meters: \(shortRun.meters)")
print("Distance in feet: \(shortRun.feet)")
/*:
