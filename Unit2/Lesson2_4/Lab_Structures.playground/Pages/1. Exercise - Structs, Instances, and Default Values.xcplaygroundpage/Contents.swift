...
favoriteBook.title = "Atomic Habits"
favoriteBook.author = "James Clear"
favoriteBook.pages = 320
favoriteBook.price = 18.00


print("My favorite book is \(favoriteBook.title).")
print("It was written by \(favoriteBook.author).")
print("It has \(favoriteBook.pages) pages.")
print("It costs $\(favoriteBook.price).")
