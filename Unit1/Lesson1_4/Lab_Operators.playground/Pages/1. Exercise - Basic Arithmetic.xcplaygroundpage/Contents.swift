...
print("The value is more accurate since we declared it as a double")
/*:
...
print("I can use the remainder operator to check if an integer is even or odd by dividing the number by 2 and looking at the remainder")
/*:
