...
var myLaptop = Laptop(yearPurchased: 2021)

var workLaptop = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2019)

print("My laptop: \(myLaptop.screenSize)-inch, repaired \(myLaptop.repairCount) times, purchased in \(myLaptop.yearPurchased).")
print("Work laptop: \(workLaptop.screenSize)-inch, repaired \(workLaptop.repairCount) times, purchased in \(workLaptop.yearPurchased).")
...
let personInInches = Height(inches: 65)
print("Height in inches: \(personInInches.heightInInches), height in centimeters: \(personInInches.heightInCentimeters)")

let personInCentimeters = Height(centimeters: 180)
print("Height in inches: \(personInCentimeters.heightInInches), height in centimeters: \(personInCentimeters.heightInCentimeters)")
